...
// .wrangler/tmp/bundle-KGfxea/checked-fetch.js
  ...
  webSocketMessage(ws, message) {
    ...
    switch (data.type) {
      ...
      case "PLAY_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can play." }));
          } catch {
          }
          break;
        }
      ...
      case "PAUSE_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can pause." }));
          } catch {
          }
          break;
        }
      ...
      case "STOP_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can stop." }));
          } catch {
          }
          break;
        }
      ...
      case "RESUME_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can resume." }));
          } catch {
          }
          break;
        }
      ...
      case "SET_TRACK_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can set track." }));
          } catch {
          }
          break;
        }
      ...
      case "QUEUE_SECTION_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can queue section." }));
          } catch {
          }
          ;
          break;
      ...
      case "CLEAR_SECTION_QUEUE_REQUEST": {
        ...
        if (u.role !== "GM") {
          try {
            ws.send(JSON.stringify({ type: "ERROR", code: "FORBIDDEN", message: "Only active user can clear section queue." }));
          } catch {
          }
          ;
          break;
      ...
      case "SYNC_RESPONSE": {
        ...
        for (const [sock, uu] of this.clients) {
          if (uu.roomId === roomId && uu.id === toId) {
            try {
              sock.send(JSON.stringify({ type: "SYNC_STATE", state: data.state || {} }));
            } catch {
            }
            break;
          }
...
// .wrangler/tmp/bundle-KGfxea/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-KGfxea/middleware-loader.entry.ts
